...
class ProductColorModel(BaseModel):
    codo = models.CharField(max_length=7, verbose_name=_('code'))
...
class ProductModel(BaseModel):
    ...
    discount_price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name=_('discount_price'), null=True, blank=True)
    ...
    brands = models.ForeignKey(
        ProductManufactureModel, on_delete=models.PROTECT, verbose_name='brands', related_name='products'
    )
